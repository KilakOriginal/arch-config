...
timeout 600 'hyprctl dispatch dpms on && systemctl suspend' \
	resume 'source /tmp/brightness_levels ; brightnessctl set $screen && brightnessctl --device="platform::kbd_backlight" s $keyboard' 
